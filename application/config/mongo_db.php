...
$config['mongo_db']['default']['hostname'] = array('127.0.0.1');
$config['mongo_db']['default']['port'] = '27017';
$config['mongo_db']['default']['username'] = 'test';
$config['mongo_db']['default']['password'] = 'test';
...
$config['mongo_db']['test']['username'] = 'pranav';
$config['mongo_db']['test']['password'] = 'pranav';
